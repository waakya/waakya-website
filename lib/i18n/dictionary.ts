  ...
  hi: {
    ...
    privacy: {
      ...
      what: [
        ...
        "बातचीत और उसमें भेजी फ़ाइलें, और जो दस्तावेज़ आप अपलोड करते हैं या टेम्पलेट से बनाते हैं।",
        "हाज़िरी: पंच इन और पंच आउट का समय, छुट्टी की अर्ज़ी, बैलेंस, हॉलिडे और मंज़ूरी।",
        "Google से साइन इन करने पर: Google से आपका नाम, ईमेल और प्रोफ़ाइल फ़ोटो।",
      ],
  ...
  "hi-Latn": {
    ...
    privacy: {
      ...
      what: [
        ...
        "Baat-cheet aur usmein bheji files, aur jo documents aap upload karte hain ya template se banate hain.",
        "Hazri: punch in aur punch out ka samay, chhutti ki request, balance, holiday aur approvals.",
        "Google se sign in karne par: Google se aapka naam, email aur profile photo.",
      ],
  ...
  en: {
    ...
    privacy: {
      ...
      what: [
        ...
        "Conversations and the files shared in them, and the documents you upload or make from templates.",
        "Attendance: punch-in and punch-out times, leave requests, leave balances, holidays and approvals.",
    ...
    lists: {
      ...
      allDone: "Good",
      noTasks: "No work yet",
      noTasksHelp: "Use New task to send work.",
      bheje: "Sent",
      dekhe: "Seen",
      hoGaye: "Done",
      verifiedCount: "Verified",
    ...
    org: {
      ...
      teamTitle: "Team",
      teamSubtitle: (count) => (count === 1 ? "1 person" : `${count} people`),
      invite: "Invite to team",
      inviteTitle: "Invite to your team",
      ...
      you: "You",
      noStaffYet: "Nobody has joined yet",
      noStaffHelp: "Invite your team first. Conversations, tasks and attendance start working once someone joins.",
      removeInvite: "Remove",
    ...
    auth: {
      ...
      subtitle: "New or returning, use Google or a six-digit code by email. No password.",
      ...
      staffHint: "Joining your team? Open the invite link your owner shared with you.",
